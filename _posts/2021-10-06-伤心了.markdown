...
title: 伤心了 #标题
date:  2021-10-6-18:55:16 +0800 #日期 必填
key: 2021-10-6-18:55:16 #页面的唯一标识符，供评论系统和点击量统计使用。必须以字母（[A-Za-z]）开头，其后可以接若干字母、数字（[0-9]）、连字符（-）、下划线（_）、冒号（:）和小数点（.）。
author: TFTree #作者
tags: ["难受"] #标签
---
...
![游戏难抵意难平](\images\难受\游戏难抵意难平.png){:.border.rounded}
